# 1. Получаем ID и жестко очищаем его от невидимых символов (оставляем только цифры)
...
# 3. Создаем контейнер ОДНОЙ строкой (без переносов), чтобы консоль не ломала команду
